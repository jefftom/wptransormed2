...
## 125 modules → 28 parents → 7 categories
...
## CORE (blue) — 6 parents · 25 modules
...
| 2 | Dashboard Manager | — | hide-dashboard-widgets, dashboard-columns, activity-feed, admin-quick-notes, client-dashboard, duplicate-widget |
...
| 5 | Keyboard Shortcuts & Bookmarks | — | keyboard-shortcuts, admin-bookmarks |
| 6 | User & Role Manager | — | multiple-user-roles, user-role-editor, session-manager, temporary-user-access, view-as-role |
...
## SECURITY (rose) — 4 parents · 13 modules

| # | Parent | Badges | Sub-modules |
|---|--------|--------|-------------|
| 13 | Firewall & Hardening | POPULAR | disable-xmlrpc, password-protection, disable-rest-api, disable-rest-fields, email-obfuscator, obfuscate-author-slugs |
| 14 | Login Protection | APP | limit-login-attempts, captcha-protection, change-login-url, login-id-type, login-logout-menu, redirect-after-login |
| 15 | Two-Factor Auth | PRO | two-factor-auth, passkey-auth |
| 16 | Audit Log | APP | audit-log |

## PERFORMANCE (green) — 4 parents · 15 modules
...
| 19 | Site Speed | — | heartbeat-control, disable-self-pingbacks, disable-attachment-pages, disable-author-archives, disable-feeds, revision-control |
| 20 | Database Optimizer | APP | database-cleanup |
...
## DEVELOPER (amber) — 4 parents · 23 modules
